...
public class MpGernater {
    ...
    //    项目输出路径
    private static String outPutDir = "D:\\java\\mybites-puls-demo\\src\\main\\java";
    //    resource路径
    private static String resourcePath = "D:\\java\\mybites-puls-demo\\src\\main\\resources";
    //    驱动
    ...
    //    顶级包结构
    private static String parentPackage = "com.supercc.demo";
    //    数据访问层包名
